...
sudo pacman --color always --force --noconfirm -S git zip ntp zsh ttf-dejavu poppler inkscape awesome-terminal-fonts terminus-font gnome gnome-tweak-tool networkmanager bspwm sxhkd termite dmenu feh compton ranger tmux htop nmap firefox atom powerline screenfetch vlc hexchat libreoffice-still obs-studio bleachbit cmatrix thunar cool-retro-term dunst redshift reflector wine
